...
const replies = [
  {
    ...
    text: "The cohort runs 6 weeks with 12 live sessions total. Expect ~6-8 hours of work weekly between live builds and practice labs.",
  },
  {
  ...
  },
  {
    ...
    text: "Phase 04 is about control. We prepare data, train with LoRA/QLoRA, evaluate, and compress so your model aligns to your domain without overfitting.",
  },
  {
    match: ["memory", "long-term", "recall", "context"],
    text: "Phase 05 dives into memory systems: persistent memory layers, temporal indexing, summarization pipelines, and context compaction.",
  },
  {
    match: ["price", "cost", "pay", "buy"],
    text: "Student Access is Rs. 15K (Foundational). Architect Class is Rs. 30K (Foundational + Advanced).",
  },
  {
