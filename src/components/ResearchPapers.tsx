...
export function ResearchPapers() {
  return (
    <Section
      kicker="Research"
      title="Research papers from the studio."
      ...
      <div className="space-y-5">
        {papers.map((paper, index) => (
          <motion.article
            ...
            className="relative flex flex-col gap-3 overflow-hidden rounded-3xl border border-white/10 bg-[var(--surface-muted)]/60 px-6 py-5 shadow-[0_0_30px_rgba(2,5,10,0.35)] md:flex-row md:items-center md:gap-6"
          >
            <motion.div
              ...
              initial={{ x: "-30%" }}
              animate={{ x: ["-30%", "30%"] }}
              transition={{ duration: 5.5, repeat: Infinity, repeatType: "reverse", ease: "easeInOut", delay: index * 0.3 }}
            />
